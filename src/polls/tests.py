...
class QuestionResultsViewTests(TestCase):
    ...
    def test_future_question_as_admin(self):
        User.objects.create_superuser(username='test_admin', password='12345')
    ...
    def test_future_question_as_non_admin_user(self):
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question_and_past_question_as_admin(self):
        User.objects.create_superuser(username='test_admin', password='12345')
        self.client.login(username='test_admin', password='12345')
